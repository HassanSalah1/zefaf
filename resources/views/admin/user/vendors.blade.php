                ...
                <div class="row">
                    <div class="form-group col-sm-3">
                        ...
                        <select id="status" class="form-control" name="status">
                            ...
                            @foreach(\App\Entities\UserStatus::getKeys() as $statusObj)
                                <option @if(isset($status) && $status === $statusObj) selected @endif
                                value="{{$statusObj}}">
                                    @if ($statusObj === \App\Entities\UserStatus::BLOCKED)
                                        Inactive
                                    @elseif ($statusObj === \App\Entities\UserStatus::REVIEW)
                                        In review
                                    @else
                                        {{$statusObj}}
                                    @endif
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            searchVendors('{{ url( (($locale === 'ar') ? $locale : '') . "/vendors/data") }}', {
        ...
        function search() {
            ...
            let url = '{{ url( (($locale === 'ar') ? $locale : '') . "/vendors/data") }}';
