                ...
                <form role="form" id="general-form">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input required type="text" id="title_ar" name="name_ar"
                                   class="form-control" value="{{$event->name_ar}}"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input required type="text" id="title_en" name="name_en"
                                   class="form-control" value="{{$event->name_en}}"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="media no-margin-top">
                                <div class="media-left">
                                    <a @if($event->image !== null)
                                       href="{{url($event->image)}}"
                                       @else
                                       href="{{url('/dashboard/images/placeholder.jpg')}}"
                                       @endif data-popup="lightbox">
                                        <img id="preview" @if($event->image !== null)
                                        src="{{url($event->image)}}"
                                             @else
                                             src="{{url('/dashboard/images/placeholder.jpg')}}"
                                             @endif
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input required type="time" id="from" name="from"
                                   class="form-control" value="{{$event->from}}"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input required type="time" id="to" name="to"
                                   class="form-control" value="{{$event->to}}"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="type" name="type">
                                <option value="online" @if($event->link !== null) selected @endif>online</option>
                                <option value="offline" @if($event->link === null) selected @endif>offline</option>
                            </select>
                        </div>
                    </div>

                    <div id="online" @if($event->link === null) style="display: none;" @endif>
                        <div class="row">
                            <div class="col-sm-6">
                    ...
                    <div id="offline" @if($event->link !== null) style="display: none;" @endif>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <textarea required id="short_description_ar" name="short_description_ar"
                                      class="form-control "
                                      placeholder="{{trans('admin.short_description_arabic')}}">{{$event->short_description_ar}}</textarea>
                        </div> <!-- form-group -->
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <textarea required id="short_description_en" name="short_description_en"
                                      class="form-control"
                                      placeholder="{{trans('admin.short_description_english')}}">{{$event->short_description_en}}</textarea>
                        </div> <!-- form-group -->
                    </div>
...
@section('script')
    ...
    <script type="text/javascript"
            src="http://maps.google.com/maps/api/js?key=AIzaSyDhoc3Xe0kB2rp77fI1lLLm6MH3I4UDdQw"></script>
    <script>
        var edit = false;
        var add = false;
        var pub_id;
    ...
    <script>
            @if($event->lat !== null)
        var editLatLng = new google.maps.LatLng(parseFloat('{{$event->lat}}'), parseFloat('{{$event->long}}'));
        @endif
    </script>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#general-form').submit(function (e) {
                e.preventDefault();
                sendAjaxRequest(this, '{{url( (($locale === 'ar') ? $locale : '') . '/event/edit')}}',
                    {
