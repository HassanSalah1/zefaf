                        ...
                        <form role="form" id="general-form">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <label class="control-label"
                                           for="user_id">{{trans('admin.users_title')}}</label>
                                    <select multiple id="user_id" class="form-control" name="user_id[]">
                                        @foreach($clients as $client)
                                            <option
                                                value="{{$client->id}}">{{$client->phone . ' - '. $client->name}}</option>
                                        @endforeach
                                    </select>
                                </div> <!-- form-group -->
                                ...
                                <div class="form-group col-sm-6">
                                    <label class="control-label"
                                           for="all_clients">all clients</label>
                                    <input type="checkbox" id="all_clients" name="all_clients"
                                    />
                                </div> <!-- form-group -->
                            </div>
