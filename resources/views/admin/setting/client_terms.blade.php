                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="{{\App\Entities\Key::CLIENT_TERMS_AR}}">
                                    {{trans('admin.' . \App\Entities\Key::CLIENT_TERMS_AR)}}
                                </label>
                                <textarea class="form-control" id="{{\App\Entities\Key::CLIENT_TERMS_AR}}"
                                          name="{{\App\Entities\Key::CLIENT_TERMS_AR}}">@if(isset($terms_ar) && $terms_ar) {{$terms_ar->value}} @endif</textarea>
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="{{\App\Entities\Key::CLIENT_TERMS_EN}}">
                                    {{trans('admin.' . \App\Entities\Key::CLIENT_TERMS_EN)}}
                                </label>
                                <textarea class="form-control" id="{{\App\Entities\Key::CLIENT_TERMS_EN}}"
                                          name="{{\App\Entities\Key::CLIENT_TERMS_EN}}">@if(isset($terms_en) && $terms_en) {{$terms_en->value}} @endif</textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#general-form').submit(function (e) {
                e.preventDefault();
                sendAjaxRequest(this, '{{url( (($locale === 'ar') ? $locale : '') . '/client/terms/save')}}',
                    {
