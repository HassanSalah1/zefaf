                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="{{\App\Entities\Key::ABOUT_AR}}">
                                    {{trans('admin.' . \App\Entities\Key::ABOUT_AR)}}
                                </label>
                                <textarea class="form-control" id="{{\App\Entities\Key::ABOUT_AR}}"
                                          name="{{\App\Entities\Key::ABOUT_AR}}">@if(isset($about_ar) && $about_ar) {{$about_ar->value}} @endif</textarea>
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="{{\App\Entities\Key::ABOUT_EN}}">
                                    {{trans('admin.' . \App\Entities\Key::ABOUT_EN)}}
                                </label>
                                <textarea class="form-control" id="{{\App\Entities\Key::ABOUT_EN}}"
                                          name="{{\App\Entities\Key::ABOUT_EN}}">@if(isset($about_en) && $about_en) {{$about_en->value}} @endif</textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#general-form').submit(function (e) {
                e.preventDefault();
                sendAjaxRequest(this, '{{url( (($locale === 'ar') ? $locale : '') . '/about/save')}}',
                    {
