        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="py-5">
                        <h1 class="page-titile">Case Studies</h1>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="thumb-blog-overlay bg-white hover-text-PushUpBottom mb-4">
                                    ...
                                    <div class="post-content py-4">
                                        <a href="{{url('/caseStudy/details/'.$product->id)}}"
                                           class="transation font-medium text-dark hover-text-primary d-block mb-2">
                                            {{$product->title}}
                                        </a>
                                        <p>{{$product->short_description}}</p>
                                        <div class="post-meta text-uppercase list-color-light">
                                            <a href="{{url('/caseStudy/details/'.$product->id)}}">
                                                <span>
